...
export ZSH="/Users/kignuf/.oh-my-zsh"
...
plugins=(git github gitignore node npm npx ssh-agent command-not-found adb aws docker docker-compose dotenv terraform)
...
# === Kignuf's additions ===
# source various dot files
for file in ~/.{bash_exports,aliases,bash_local}; do
